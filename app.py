...
def getdata(query):
    ...
    if len(res)==0:
        ...
        Link = res['Link'].values[0]
        imgUrl = res['ImgUrl'].values[0]
        Singup = res['Singup'].values[0]
        Prom = res['Prom'].values[0]
        return Link,imgUrl,Singup,Prom
